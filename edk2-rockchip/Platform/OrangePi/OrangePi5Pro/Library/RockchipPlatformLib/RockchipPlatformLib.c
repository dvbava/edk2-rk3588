...
{
  switch (Segment) {
    case PCIE_SEGMENT_PCIE20L1: // NVMe
      GpioPinSetDirection (4, GPIO_PIN_PA2, GPIO_PIN_OUTPUT);
      break;
    case PCIE_SEGMENT_PCIE20L2: // PCIe NIC
...
{
  GpioPinSetFunction (3, GPIO_PIN_PB1, 0xB); // PWM2_M1
...
{
  GpioPinWrite (0, GPIO_PIN_PD0, Enable);
  ...
  )
{
  ...
  GpioPinSetFunction (1, GPIO_PIN_PD5, 0); // headphone detect
}
